...
```
git clone https://github.com/techhiveRepo/react-sample-dashboard-1
```
2. Navigate to the project directory:
```
cd react-sample-dashboard-1
```
...
Default port is 5200.
This command will start the development server and automatically open your default browser to [localhost:5200](http://localhost:5200/).
